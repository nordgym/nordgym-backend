...
public class Constants {
    ...
    public final static String INVALID_SUBSCRIPTION_NUMBER_DUPLICATED = "DUPLICATED_SUBSCRIPTION_NUMBER";
    public static final String ERROR_MESSAGE = "errorMessage";
    public static final String USER_SUBSCRIPTION_NUMBER_ERROR_MESSAGE =
            "User's subscription number must be exactly 10 characters long and contains only digits";
